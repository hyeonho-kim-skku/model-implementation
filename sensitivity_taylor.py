...
def build_parser():
    ...
    parser.add_argument("--gate-taylor-aggregation", dest="gate_taylor_aggregation", type=str, choices=["elementwise", "samplewise", "channelwise"], default="elementwise", help="Aggregation unit for gate_taylor scores")
    return parser

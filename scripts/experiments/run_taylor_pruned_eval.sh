...
LOG_DIR="${LOG_DIR:-logs/taylor_pruned_eval_$(TZ="$TIMEZONE" date +%Y%m%d_%H%M%S)}"
...
run_experiment "taylor_pruned_eval_cifar100" \
  ...
  "pruned/vit_base_cifar100_lora50_mlp030_taylor/eval_metrics.json"

run_experiment "taylor_pruned_eval_flowers102" \
  "configs/taylor_pruned_eval_flowers102.yaml" \
  "pruned/vit_base_flowers102_lora50_mlp030_taylor/eval_metrics.json"

run_experiment "taylor_pruned_eval_cub200" \
  "configs/taylor_pruned_eval_cub200.yaml" \
  "pruned/vit_base_cub200_lora50_mlp030_taylor/eval_metrics.json"

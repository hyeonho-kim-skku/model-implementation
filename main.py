...
if __name__ == "__main__":
    ...
    parser.add_argument('--num-kv-prompt-tokens', dest='num_kv_prompt_tokens', type=int, default=5, help='Number of shared key-value prompt tokens per attention layer')
